...
Research-grade interpolation: linear, Lagrange polynomial, cubic natural spline, barycentric — pure Rust, no dependencies
...
```bash
git clone https://github.com/SuperInstance/numerics-interp
cd numerics-interp
```
